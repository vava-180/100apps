...
🌐 **公開サイト（ブラウザで試せるデモ付き）: https://vava-180.github.io/100apps/**
...
| 056 | 表をPowerPointへ自動転記（Excel→PPT） | ✅ | [ExportRangeToPpt.bas](day056-vba-excel-to-ppt/ExportRangeToPpt.bas) |
| 057 | 目次スライド自動生成（PowerPoint） | ✅ | [CreateTocSlide.bas](day057-vba-ppt-toc/CreateTocSlide.bas) |
| 058 | 全スライドのフォント統一（PowerPoint） | ✅ | [UnifyFont.bas](day058-vba-ppt-font/UnifyFont.bas) |
| 059 | 画像を一括でスライド化（PowerPoint） | ✅ | [ImagesToSlides.bas](day059-vba-ppt-images/ImagesToSlides.bas) |
...
| 081 | QRコード表示 | ✅ | [main.dart](day081-flutter-qrcode/lib/main.dart) |
| 082 | カラーピッカー | ✅ | [main.dart](day082-flutter-colorpicker/lib/main.dart) |
| 083 | おみくじ | ✅ | [main.dart](day083-flutter-omikuji/lib/main.dart) |
| 084 | サイコロ | ✅ | [main.dart](day084-flutter-dice/lib/main.dart) |
| 085 | 抽選・ガチャ | ✅ | [main.dart](day085-flutter-gacha/lib/main.dart) |
| 086 | 名言表示 | ✅ | [main.dart](day086-flutter-quotes/lib/main.dart) |
| 087 | 単語帳（フラッシュカード） | ✅ | [main.dart](day087-flutter-flashcard/lib/main.dart) |
| 088 | 日記 | ✅ | [main.dart](day088-flutter-diary/lib/main.dart) |
| 089 | 多言語あいさつ | ✅ | [main.dart](day089-flutter-greeting/lib/main.dart) |
| 090 | ミニ電卓 | ✅ | [main.dart](day090-flutter-calculator/lib/main.dart) |

フェーズ4（Flutter）完了 🎉　Day 091 以降はフェーズ5（自由選択）です。
※ Day 081 のみ `qr_flutter`（QR描画・オフライン動作）を使用。他はすべて追加パッケージなし。
...
| Day | アプリ | 状態 | コード |
|----:|--------|:----:|:----:|
| 101 | アプリハブ（Day66–90を集約・非表示機能つき / Flutter） | ✅ | [main.dart](day101-flutter-hub/lib/main.dart) |
